...
class MainFile():
    ...
    def append_entry(self, entry, parent_ical, id = None):
        ...
        try:
            ...
            self.__c.execute("INSERT INTO entries VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')".format(ical_id, start_date, leave_date, amount, "Guest-{}".format(parent_ical.get_id()), service, email, phone, 0, 0, '', entry_id, ''))
            print('skipping')
